...
alert ('Если ты гей нажми "OK"'); // выводит текст на экран в виде модального окна

let message; // переменная и название переменной
message = 'Хорош, признался'; // можно поместить данные с помощьбю оператора присваивания "=" 

alert (message); // вывод переменной

let message2 = 'Но ты уверен?'; // однострочная функция
